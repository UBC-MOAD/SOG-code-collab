...
subroutine allocate1(STAT)
      ...
      ALLOCATE(alph%g(0:M+1),alph%i(0:M),alph%idiv(M),beta%idiv(M),beta%g(0:M+1),beta%i(0:M),&
               Cp%g(0:M+1),Cp%i(0:M), w%b(0:M),w%b_old(0:M),w%b_err(0:M),w%b_err_old(0:M),Bf%b(0:M),&
      ...
      ALLOCATE(Hvector%s(M),Hvector%t(M),Hvector%u(M),Hvector%v(M),Hvector%p%micro(M),Hvector%p%nano(M),&
               ...
               Gvector_ro%n%o(M), Gvector_ro%n%h(M), Gvector_ro_o%n%o(M), Gvector_ro_o%n%h(M),&
      ...
      ALLOCATE(micro%growth%light(M),micro%growth%new(M),nano%growth%light(M),nano%growth%new(M),&
           ...
           P_q(M),P_f(M),P_no(M),P_nh(M),P_di(M),P_na(M),P_mi(M),P_d1(M),P_d2(M),P_sa(M),P_u(M),P_v(M),P_ta(M),wupwell(M+1), &
           STAT = alloc_stat(10))
